<table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #f0f0f0;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
          ...
          <img style="border: 0;display: block;height: auto;width: 100%;max-width: 50px;" alt="" width="50" src="http://157.245.86.91/assets/media/logos/logo-5.png">
            ...
            <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 20px;">
              <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
                <h4 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #565656;font-size: 18px;line-height: 26px;text-align: center;"><strong>{{__('Master.mr_or_ms')}}:{{$fullname}}</strong></h4>
              </div>
            </div>
            <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 20px;">
              <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
                <h2 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #565656;font-size: 18px;line-height: 26px;text-align: center;"><strong>{{$content}}</strong></h2>
              </div>
            </div>
      ...
      <div style="mso-line-height-rule: exactly;line-height: 10px;font-size: 1px;">&nbsp;</div>
            ...
            <div style="Margin-left: 20px;Margin-right: 20px;">
      <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
        <p style="Margin-top: 0;Margin-bottom: 20px;text-align: center;"><em>Hessa Team</em></p>
      </div>
    </div>
