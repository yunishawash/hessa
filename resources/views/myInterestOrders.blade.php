...
@section('pageTitle')
 {{ __("Master.MyInterestOrderTitle") }}
@endSection
   ...
   columnDefs: [
    {
     ...
     render: function(data, type, full, meta) {
      return `
            <a href="#" data-record-id=`+full.order_id+` class="btn btn-sm btn-clean btn-icon btn-icon-md btn-interest" title="{{ __("Master.Cancel_interest") }}">
